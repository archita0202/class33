...
function setup() {
  ...
  button1.position(width/2 -100,70);
  button1.size(50,50);
  button1.mouseClicked(drop1);

  button2 = createImg('cut_btn.png');
  button2.position(width/2 +100,130);
  button2.size(50,50);
  button2.mouseClicked(drop2);

  blower = createImg('balloon.png');
  blower.position(50,height/2);
  blower.size(150,150);
  ...
  rope = new Rope(7,{x:width/2 +5,y:30});
  rope2 = new Rope(5,{x:width/2 +105,y:130});
  rope1 = new Rope(10,{x:width/2 -95,y:70});
